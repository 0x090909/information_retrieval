...
Si pu\`o vederne un esempio in Figura 2.
...
\`E risultato utile sfruttare un modulo legato a whoosh (paginate-whoosh\footnote{\url{https://getbootstrap.com/}})
...
Per come \`e scritta la funzione di ricerca, non sarebbe difficile
...
La Figura 5 riassume i risultati delle tre prove e si pu\`o notare un netto miglioramento utilizzando le stopword migliorate.
