...
Nel contesto del modello probabilistico, lo schema di pesatura comunemente utilizzato nella funzione che assegna l'ordine ai documenti \`e il cos\`i detto BM25\cite{WBC} (Best Matching 25).
